        ...
        <div className="justify-center space-x-2 md:flex">
          ...
          <div className="text-white hidden md:flex md:justify-center items-center w-[50%]  bg-gradient-to-br from-[rgba(209,209,209,0.2)] to-[rgba(209,209,209,0.1)] backdrop-blur-[5px] rounded-3xl lg:h-auto md:h-[600px]">
            <div className="flex flex-col justify-evenly p-8 space-y-8 h-[90%]">
              ...
              {props.title !== "Previous" ? (
                <button
                  type="button"
                  className="text-white bg-[#2F8D46] rounded-xl hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:shadow-green-800/80 dark:focus:shadow-green-800/80 shadow-lg shadow-green-800/80 dark:shadow-lg dark:shadow-green-800/80 font-medium  text-xs md:text-sm px-5 py-2.5 text-center mr-2 mb-2 "
                >
                  <a
          ...
          {props.title !== "Previous" ? (
            <div className="mt-6 text-center md:hidden">
              <button
                type="button"
                className="text-white  bg-[#2F8D46] rounded-xl hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:shadow-green-800/80 dark:focus:shadow-green-800/80 shadow-lg shadow-green-800/80 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-md  px-10 py-2.5 text-center  "
              >
                <a
                  href={props.data[currentSlide] ? props.data[currentSlide].link : ""}
                  target="_blank"
