    ...
    <div className="text-white mt-24 min-h-screen sm:mx-12 md:mx-24 lg:mx-32 mb-8">
      ...
      >
        <TitleText
          title={
            <>
              <div className="eur text-2xl lg:text-7xl font-extrabold text-white my-4 lg:my-6 ">
      ...
      <div className="  flex  sm:flex-col-reverse  justify-center items-center mt-10  xs: flex-col-reverse ">
        ...
        <div className="chame flex flex-row mb-2 items-center w-full sm:w-1/5 lg:w-1/3 justify-center">
