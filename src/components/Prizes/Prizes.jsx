  ...
  return (
    <div className="container mx-auto my-8">
        ...
        <TitleText
          title={
            <>
              ...
              <div className="family bg-gradient-to-r from-blue-500 to-yellow-500 text-transparent text-4xl lg:text-7xl font-bold text-[#DEECE4] my-3 lg:my-4  ">
                PRIZES
              </div>
            </>
          }
      ...
      <div className="prizes">
        <div className=" family  block grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        sm:text-4xl text-2xl flex font-bold mb-2 text-white font-[Inter]"
            >
              ₹15K
              <p className="text-sm m-2  text-gray-400 font-[Inter] lg:m-3"></p>
            </h1>
            <h5
              className="sep lg:text-3xl
        sm:text-xl text-base font-semibold text-white my-1 font-[Inter]"
            >
              SECOND PRIZE
            </h5>
