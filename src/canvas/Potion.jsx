...
const Computers = ({ isMobile , isTablet}) => {
  ...
  const computer = useGLTF("./mermaid_potion.glb");
...
<spotLight
      ...
      <primitive
        ...
        scale={isMobile ? 0.7 : isTablet ? 8 : 0.007}
        position={isMobile ? [0, -3, -2.5] : isTablet ? [0, -6, 0] : [0, -4.8, 0]}
        rotation={[0, 0, 0]} 
      />
    </mesh>
  );
